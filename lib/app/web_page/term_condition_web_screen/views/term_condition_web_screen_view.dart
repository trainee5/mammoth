...
class TermConditionWebScreenView
    extends GetView<TermConditionWebScreenController> {
  const TermConditionWebScreenView({super.key});
  @override
  Widget build(BuildContext context) {


    Get.put(TermConditionWebScreenController());

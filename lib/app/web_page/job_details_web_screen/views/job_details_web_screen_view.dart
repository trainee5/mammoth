...
class JobDetailsWebScreenView extends GetView<JobDetailsWebScreenController> {
  const JobDetailsWebScreenView({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    Get.put(JobDetailsWebScreenController());
